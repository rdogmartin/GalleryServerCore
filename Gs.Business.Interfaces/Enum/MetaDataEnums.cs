...
namespace GalleryServer.Business.Metadata
{
    ...
    public enum RawMetadataItemName : int
    {
        ...
        GPSDateStamp = 29,
        GPSDifferential = 30,
        [ExifTagDescription(0U, "Full-resolution Image"), ExifTagDescription(1U, "Reduced-resolution image"), ExifTagDescription(2U, "Single page of multi-page image"), ExifTagDescription(3U, "Single page of multi-page reduced-resolution image"), ExifTagDescription(4U, "Transparency mask"), ExifTagDescription(5U, "Transparency mask of reduced-resolution image"), ExifTagDescription(6U, "Transparency mask of multi-page image"), ExifTagDescription(7U, "Transparency mask of reduced-resolution multi-page image"), ExifTagDescription(65537U, "Alternate reduced-resolution image ")] SubfileType = 254,
        [ExifTagDescription(1, "Full-resolution Image"), ExifTagDescription(2, "Reduced-resolution image"), ExifTagDescription(3, "Single page of multi-page image")] OldSubfileType = 255,
        ImageWidth = 256,
        ImageLength = 257,
        BitsPerSample = 258,
        [ExifTagDescription(1, "Uncompressed"), ExifTagDescription(2, "CCITT 1D"), ExifTagDescription(3, "T4/Group 3 Fax"), ExifTagDescription(4, "T6/Group 4 Fax"), ExifTagDescription(5, "LZW"), ExifTagDescription(6, "JPEG (old-style)"), ExifTagDescription(7, "JPEG"), ExifTagDescription(8, "Adobe Deflate"), ExifTagDescription(9, "JBIG B&W"), ExifTagDescription(10, "JBIG Color"), ExifTagDescription(99, "JPEG"), ExifTagDescription(262, "Kodak 262"), ExifTagDescription(32766, "Next"), ExifTagDescription(32767, "Sony ARW Compressed"), ExifTagDescription(32769, "Packed RAW"), ExifTagDescription(32770, "Samsung SRW Compressed"), ExifTagDescription(32771, "CCIRLEW"), ExifTagDescription(32772, "Samsung SRW Compressed 2"), ExifTagDescription(32773, "PackBits"), ExifTagDescription(32809, "Thunderscan"), ExifTagDescription(32867, "Kodak KDC Compressed"), ExifTagDescription(32895, "IT8CTPAD"), ExifTagDescription(32896, "IT8LW"), ExifTagDescription(32897, "IT8MP"), ExifTagDescription(32898, "IT8BL"), ExifTagDescription(32908, "PixarFilm"), ExifTagDescription(32909, "PixarLog"), ExifTagDescription(32946, "Deflate"), ExifTagDescription(32947, "DCS"), ExifTagDescription(34661, "JBIG"), ExifTagDescription(34676, "SGILog"), ExifTagDescription(34677, "SGILog24"), ExifTagDescription(34712, "JPEG 2000"), ExifTagDescription(34713, "Nikon NEF Compressed"), ExifTagDescription(34715, "JBIG2 TIFF FX"), ExifTagDescription(34718, "Microsoft Document Imaging (MDI) Binary Level Codec"), ExifTagDescription(34719, "Microsoft Document Imaging (MDI) Progressive Transform Codec"), ExifTagDescription(34720, "Microsoft Document Imaging (MDI) Vector"), ExifTagDescription(34892, "Lossy JPEG"), ExifTagDescription(65000, "Kodak DCR Compressed"), ExifTagDescription(65535, "Pentax PEF Compressed")] Compression = 259,
        [ExifTagDescription(0, "WhiteIsZero"), ExifTagDescription(1, "BlackIsZero"), ExifTagDescription(2, "RGB"), ExifTagDescription(3, "RGB Palette"), ExifTagDescription(4, "Transparency Mask"), ExifTagDescription(5, "CMYK"), ExifTagDescription(6, "YCbCr"), ExifTagDescription(8, "CIELab"), ExifTagDescription(9, "ICCLab"), ExifTagDescription(10, "TULab"), ExifTagDescription(32803, "Color Filter Array"), ExifTagDescription(32844, "Pixar LogL"), ExifTagDescription(32845, "Pixar LogLuv"), ExifTagDescription(34892, "Linear Raw")] PhotometricInterpretation = 262,
        [ExifTagDescription(1, "No dithering or halftoning"), ExifTagDescription(2, "Ordered dither or halftone"), ExifTagDescription(3, "Randomized dither")] Thresholding = 263,
        CellWidth = 264,
        CellLength = 265,
        [ExifTagDescription(1, "Normal"), ExifTagDescription(2, "Reversed")] FillOrder = 266,
        DocumentName = 269,
        ImageDescription = 270,
        Make = 271,
        Model = 272,
        StripOffsets = 273,
        [ExifTagDescription(1, "Horizontal (normal)"), ExifTagDescription(2, "Mirror horizontal"), ExifTagDescription(3, "Rotate 180"), ExifTagDescription(4, "Mirror vertical"), ExifTagDescription(5, "Mirror horizontal and rotate 270 CW"), ExifTagDescription(6, "Rotate 90 CW"), ExifTagDescription(7, "Mirror horizontal and rotate 90 CW"), ExifTagDescription(8, "Rotate 270 CW")] Orientation = 274,
        SamplesPerPixel = 277,
        RowsPerStrip = 278,
        StripByteCounts = 279,
        MinSampleValue = 280,
        ...
        XResolution = 282,
        YResolution = 283,
        [ExifTagDescription(1, "Chunky"), ExifTagDescription(2, "Planar")] PlanarConfiguration = 284,
        PageName = 285,
        XPosition = 286,
        YPosition = 287,
        FreeOffsets = 288,
        FreeByteCounts = 289,
        [ExifTagDescription(1, "0.1"), ExifTagDescription(2, "0.001"), ExifTagDescription(3, "0.0001"), ExifTagDescription(4, "1e-05"), ExifTagDescription(5, "1e-06")] GrayResponseUnit = 290,
        GrayResponseCurve = 291,
        [ExifTagDescription(0U, "2-Dimensional encoding"), ExifTagDescription(1U, "Uncompressed"), ExifTagDescription(2U, "Fill bits added")] T4Options = 292,
        [ExifTagDescription(1U, "Uncompressed")] T6Options = 293,
        [ExifTagDescription(1, "None"), ExifTagDescription(2, "Inches"), ExifTagDescription(3, "Centimeter")] ResolutionUnit = 296,
        PageNumber = 297,
        ...
        TileByteCounts = 325,
        BadFaxLines = 326,
        [ExifTagDescription(0U, "Clean"), ExifTagDescription(1U, "Regenerated"), ExifTagDescription(2U, "Unclean")] CleanFaxData = 327,
        ConsecutiveBadFaxLines = 328,
        [ExifTagDescription(1, "CMYK"), ExifTagDescription(2, "Not CMYK")] InkSet = 332,
        InkNames = 333,
        NumberOfInks = 334,
        DotRange = 336,
        TargetPrinter = 337,
        [ExifTagDescription(0, "Unspecified"), ExifTagDescription(1, "Associated Alpha"), ExifTagDescription(2, "Unassociated Alpha")] ExtraSamples = 338,
        [ExifTagDescription(1, "Unsigned"), ExifTagDescription(2, "Signed"), ExifTagDescription(3, "Float"), ExifTagDescription(4, "Undefined"), ExifTagDescription(5, "Complex int"), ExifTagDescription(6, "Complex float")] SampleFormat = 339,
        SMinSampleValue = 340,
        SMaxSampleValue = 341,
        TransferRange = 342,
        ClipPath = 343,
        XClipPathUnits = 344,
        YClipPathUnits = 345,
        [ExifTagDescription(0, "Not indexed"), ExifTagDescription(1, "Indexed")] Indexed = 346,
        JPEGTables = 347,
        [ExifTagDescription(0, "Higher resolution image does not exist"), ExifTagDescription(1, "Higher resolution image exists")] OPIProxy = 351,
        [ExifTagDescription(0U, "Unspecified"), ExifTagDescription(1U, "Group 3 FAX")] ProfileType = 401,
        [ExifTagDescription(0, "Unknown"), ExifTagDescription(1, "Minimal B&W lossless, S"), ExifTagDescription(2, "Extended B&W lossless, F"), ExifTagDescription(3, "Lossless JBIG B&W, J"), ExifTagDescription(4, "Lossy color and grayscale, C"), ExifTagDescription(5, "Lossless color and grayscale, L"), ExifTagDescription(6, "Mixed raster content, M"), ExifTagDescription(7, "Profile T"), ExifTagDescription(255, "Multi Profiles")] FaxProfile = 402,
        [ExifTagDescription(0UL, "Unspecified compression"), ExifTagDescription(1UL, "Modified Huffman"), ExifTagDescription(2UL, "Modified Read"), ExifTagDescription(4UL, "Modified MR"), ExifTagDescription(8UL, "JBIG"), ExifTagDescription(16UL, "Baseline JPEG"), ExifTagDescription(32UL, "JBIG color")] CodingMethods = 403,
        VersionYear = 404,
        ModeNumber = 405,
        Decode = 433,
        DefaultImageColor = 434,
        T82ptions = 435,
        [ExifTagDescription(1, "Baseline"), ExifTagDescription(14, "Lossless")] JPEGProc = 512,
        ...
        [ExifTagDescription(1, "Centered"), ExifTagDescription(2, "Co-sited")] YCbCrPositioning = 531,
        ...
        SubIFDOffset = 34665,
        ImageLayer = 34732,
        [ExifTagDescription(0, "Not Defined"), ExifTagDescription(1, "Manual"), ExifTagDescription(2, "Program AE"), ExifTagDescription(3, "Aperture-priority AE"), ExifTagDescription(4, "Shutter speed priority AE"), ExifTagDescription(5, "Creative (Slow speed)"), ExifTagDescription(6, "Action (High speed)"), ExifTagDescription(7, "Portrait"), ExifTagDescription(8, "Landscape"), ExifTagDescription(9, "Bulb")] ExposureProgram = 34850,
        ...
        SelfTimerMode = 34859,
        [ExifTagDescription(0, "Unknown"), ExifTagDescription(1, "Standard Output Sensitivity"), ExifTagDescription(2, "Recommended Exposure Index"), ExifTagDescription(3, "ISO Speed"), ExifTagDescription(4, "Standard Output Sensitivity and Recommended Exposure Index"), ExifTagDescription(5, "Standard Output Sensitivity and ISO Speed"), ExifTagDescription(6, "Recommended Exposure Index and ISO Speed"), ExifTagDescription(7, "Standard Output Sensitivity, Recommended Exposure Index and ISO Speed")] SensitivityType = 34864,
        ...
        [ExifTagDescription(0, "Unknown"), ExifTagDescription(1, "Average"), ExifTagDescription(2, "Center-weighted average"), ExifTagDescription(3, "Spot"), ExifTagDescription(4, "Multi-spot"), ExifTagDescription(5, "Multi-segment"), ExifTagDescription(6, "Partial"), ExifTagDescription(255, "Other")] MeteringMode = 37383,
        [ExifTagDescription(0, "Unknown"), ExifTagDescription(1, "Daylight"), ExifTagDescription(2, "Fluorescent"), ExifTagDescription(3, "Tungsten (Incandescent)"), ExifTagDescription(4, "Flash"), ExifTagDescription(9, "Fine Weather"), ExifTagDescription(10, "Cloudy"), ExifTagDescription(11, "Shade"), ExifTagDescription(12, "Daylight Fluorescent"), ExifTagDescription(13, "Day White Fluorescent"), ExifTagDescription(14, "Cool White Fluorescent"), ExifTagDescription(15, "White Fluorescent"), ExifTagDescription(16, "Warm White Fluorescent"), ExifTagDescription(17, "Standard Light A"), ExifTagDescription(18, "Standard Light B"), ExifTagDescription(19, "Standard Light C"), ExifTagDescription(20, "D55"), ExifTagDescription(21, "D65"), ExifTagDescription(22, "D75"), ExifTagDescription(23, "D50"), ExifTagDescription(24, "ISO Studio Tungsten"), ExifTagDescription(255, "Other")] LightSource = 37384,
        [ExifTagDescription(0, "No Flash"), ExifTagDescription(1, "Fired"), ExifTagDescription(5, "Fired, Return not detected"), ExifTagDescription(7, "Fired, Return detected"), ExifTagDescription(8, "On, Did not fire"), ExifTagDescription(9, "On, Fired"), ExifTagDescription(13, "On, Return not detected"), ExifTagDescription(15, "On, Return detected"), ExifTagDescription(16, "Off, Did not fire"), ExifTagDescription(20, "Off, Did not fire, Return not detected"), ExifTagDescription(24, "Auto, Did not fire"), ExifTagDescription(25, "Auto, Fired"), ExifTagDescription(29, "Auto, Fired, Return not detected"), ExifTagDescription(31, "Auto, Fired, Return detected"), ExifTagDescription(32, "No flash function"), ExifTagDescription(48, "Off, No flash function"), ExifTagDescription(65, "Fired, Red-eye reduction"), ExifTagDescription(69, "Fired, Red-eye reduction, Return not detected"), ExifTagDescription(71, "Fired, Red-eye reduction, Return detected"), ExifTagDescription(73, "On, Red-eye reduction"), ExifTagDescription(77, "On, Red-eye reduction, Return not detected"), ExifTagDescription(69, "On, Red-eye reduction, Return detected"), ExifTagDescription(80, "Off, Red-eye reduction"), ExifTagDescription(88, "Auto, Did not fire, Red-eye reduction"), ExifTagDescription(89, "Auto, Fired, Red-eye reduction"), ExifTagDescription(93, "Auto, Fired, Red-eye reduction, Return not detected"), ExifTagDescription(95, "Auto, Fired, Red-eye reduction, Return detected")] Flash = 37385,
        FocalLength = 37386,
        FlashEnergy2 = 37387,
        ...
        [ExifTagDescription(1, "None"), ExifTagDescription(2, "Inches"), ExifTagDescription(3, "Centimeter"), ExifTagDescription(4, "Millimeter"), ExifTagDescription(5, "Micrometer")] FocalPlaneResolutionUnit2 = 37392,
        ImageNumber = 37393,
        [ExifTagDescription("C", "Confidential"), ExifTagDescription("R", "Restricted"), ExifTagDescription("S", "Secret"), ExifTagDescription("T", "Top Secret"), ExifTagDescription("U", "Unclassified")] SecurityClassification = 37394,
        ImageHistory = 37395,
        SubjectArea = 37396,
        ExposureIndex2 = 37397,
        TIFFEPStandardID = 37398,
        [ExifTagDescription(1, "Not defined"), ExifTagDescription(2, "One-chip color area"), ExifTagDescription(3, "Two-chip color area"), ExifTagDescription(4, "Three-chip color area"), ExifTagDescription(5, "Color sequential area"), ExifTagDescription(7, "Trilinear"), ExifTagDescription(8, "Color sequential linear")] SensingMethod2 = 37399,
        MakerNote = 37500,
        UserComment = 37510,
        SubsecTime = 37520,
        ...
        [ExifTagDescription(1, "sRGB"), ExifTagDescription(2, "Adobe RGB"), ExifTagDescription(4093, "Wide Gamut RGB"), ExifTagDescription(65534, "ICC Profile"), ExifTagDescription(65535, "Uncalibrated")] ColorSpace = 40961,
        ...
        [ExifTagDescription(1, "None"), ExifTagDescription(2, "Inches"), ExifTagDescription(3, "Centimeter"), ExifTagDescription(4, "Millimeter"), ExifTagDescription(5, "Micrometer")] FocalPlaneResolutionUnit = 41488,
        SubjectLocation = 41492,
        ExposureIndex = 41493,
        [ExifTagDescription(1, "Not defined"), ExifTagDescription(2, "One-chip color area"), ExifTagDescription(3, "Two-chip color area"), ExifTagDescription(4, "Three-chip color area"), ExifTagDescription(5, "Color sequential area"), ExifTagDescription(7, "Trilinear"), ExifTagDescription(8, "Color sequential linear")] SensingMethod = 41495,
        FileSource = 41728,
        SceneType = 41729,
        CFAPattern = 41730,
        [ExifTagDescription(1, "Normal"), ExifTagDescription(2, "Custom")] CustomRendered = 41985,
        [ExifTagDescription(0, "Auto"), ExifTagDescription(1, "Manual"), ExifTagDescription(2, "Auto bracket")] ExposureMode = 41986,
        [ExifTagDescription(0, "Auto"), ExifTagDescription(1, "Manual")] WhiteBalance = 41987,
        DigitalZoomRatio = 41988,
        FocalLengthIn35mmFilm = 41989,
        [ExifTagDescription(0, "Standard"), ExifTagDescription(1, "Landscape"), ExifTagDescription(2, "Portrait"), ExifTagDescription(3, "Night")] SceneCaptureType = 41990,
        [ExifTagDescription(0, "None"), ExifTagDescription(1, "Low gain up"), ExifTagDescription(2, "High gain up"), ExifTagDescription(3, "Low gain down"), ExifTagDescription(4, "High gain down")] GainControl = 41991,
        [ExifTagDescription(0, "Normal"), ExifTagDescription(1, "Low"), ExifTagDescription(2, "High")] Contrast = 41992,
        [ExifTagDescription(0, "Normal"), ExifTagDescription(1, "Low"), ExifTagDescription(2, "High")] Saturation = 41993,
        [ExifTagDescription(0, "Normal"), ExifTagDescription(1, "Soft"), ExifTagDescription(2, "Hard")] Sharpness = 41994,
        DeviceSettingDescription = 41995,
        [ExifTagDescription(0, "Unknown"), ExifTagDescription(1, "Macro"), ExifTagDescription(2, "Close"), ExifTagDescription(3, "Distant")] SubjectDistanceRange = 41996,
        ImageUniqueID = 42016,
        OwnerName = 42032,
        SerialNumber = 42033,
        LensInfo = 42034,
    ...
    internal sealed class ExifTagDescriptionAttribute : Attribute
    {
        ...
        /// The <see cref="string"/>.
        /// </returns>
        public static string GetDescription(RawMetadataItemName tag, object value)
        {
