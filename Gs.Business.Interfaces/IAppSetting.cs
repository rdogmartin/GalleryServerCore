...
namespace GalleryServer.Business.Interfaces
{
    ...
    public interface IAppSetting
    {
        ...
        /// <summary>
        /// Gets the full path to the wwwroot directory of the gallery web application. This can be populated from
        /// IHostingEnvironment.WebRootPath.  Ex: C:\inetpub\wwwroot\gallery\wwwroot
        /// </summary>
        string WebRootPath { get; }

        /// <summary>
        /// Gets the full path to the directory of the gallery web application. This can be populated from
        /// IHostingEnvironment.ContentRootPath.  Ex: C:\inetpub\wwwroot\gallery
        /// </summary>
        ...
        /// <param name="webRootPath">The full path to the wwwroot directory of the gallery web application. This can be populated from
        /// IHostingEnvironment.WebRootPath.  Ex: C:\inetpub\wwwroot\gallery\wwwroot</param>
        /// <param name="contentRootPath">The full path to the directory of the gallery web application. This can be populated from
        /// IHostingEnvironment.ContentRootPath.  Ex: C:\inetpub\wwwroot\gallery</param>
        ...
        /// <exception cref="T:System.InvalidOperationException">Thrown when this method is called more than once during
        /// the application's lifetime.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">Thrown if the trustLevel parameter has the value
        /// ApplicationTrustLevel.None.</exception>
        /// <exception cref="T:System.ArgumentNullException">Thrown when <paramref name="physicalAppPath" /> or <paramref name="appName" />
        /// is null.</exception>
        /// <exception cref="T:GalleryServer.Events.CustomExceptions.CannotWriteToDirectoryException">
        ...
        /// <see cref="F:GalleryServer.Business.GlobalConstants.TempUploadDirectory" />), or the App_Data directory.</exception>
        void Initialize(ApplicationTrustLevel trustLevel, string webRootPath, string contentRootPath, string appName, string galleryResourcesPath);
