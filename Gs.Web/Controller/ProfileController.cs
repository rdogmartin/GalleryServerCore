...
namespace GalleryServer.Web.Controller
{
    ...
    public static class ProfileController
    {
        ...
        {
            // .NET Core: Don't use session anymore. If it's important to persist information for anonymous users (which is the only reason
            // for this method), then store in the browser.
            return null;
