    ...
    public class Factory
    {
        ...
        public static void LoadAlbumInstance(IAlbum album, bool inflateChildMediaObjects)
        {
            ...
            if (album.IsInflated && !inflateChildMediaObjects)
                throw new InvalidOperationException("It is not valid to call LoadInstance(IAlbum album) when the album is already inflated and inflateChildMediaObjects=false.");
        ...
        /// </summary>
        /// <returns>System.String.</returns>
        public static ProviderDataStore GetDataProvider()
        {
            using (var repo = new GalleryRepository())
            {
                return repo.ProviderDataStore;
            }
        }
