...
namespace GalleryServer.Business.Metadata
{
    ...
    public class MetadataItem
    {
        ...
        /// <summary>
        /// Extracts the value of the current ImageProperty and stores it in the private field _propertyItemValue. 
        /// The type of the converted value is stored in the ExtractedValueType property.
        /// </summary>
