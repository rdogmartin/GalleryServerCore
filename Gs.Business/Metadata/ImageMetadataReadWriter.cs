    ...
    public class ImageMetadataReadWriter : MediaObjectMetadataReadWriter
    {
        ...
        private IMetaValue GetColorRepresentation()
        {
            ...
            if (RawMetadata.TryGetValue(RawMetadataItemName.ColorSpace, out rawMdi))
            {
                ...
                if (value == "1")
                    return new MetaValue("sRGB", value);
                else
                    return new MetaValue("Uncalibrated", value);
            }
        ...
        private IMetaValue GetExposureCompensation()
        {
            ...
            if (expComp.HasValue)
            {
                return new MetaValue(
                  String.Concat(expComp.Value.ToString("##0.# ", CultureInfo.InvariantCulture), "step"),
        ...
        private IMetaValue GetExposureTime()
        {
            ...
            if (RawMetadata.TryGetValue(RawMetadataItemName.ExposureTime, out rawMdi))
            {
                ...
                return new MetaValue(String.Concat(exposureTime, " sec."), exposureTime);
            }
        ...
        private IMetaValue GetFocalLength()
        {
            ...
            if (focalLength.HasValue)
            {
                return new MetaValue(String.Concat(Math.Round(focalLength.Value), " mm"), focalLength.Value.ToString(CultureInfo.InvariantCulture));
            }
        ...
        private IMetaValue GetHeight()
        {
            ...
            return (height > 0 ? new MetaValue(String.Concat(height, " px"), height.ToString(CultureInfo.InvariantCulture)) : null);
        }
        ...
        private IMetaValue GetIsoSpeed()
        {
            ...
            {
                return new MetaValue(String.Concat("ISO-", isoSpeed.Value), isoSpeed.Value.ToString(CultureInfo.InvariantCulture));
            }
        ...
        private IMetaValue GetSubjectDistance()
        {
            ...
            if (RawMetadata.TryGetValue(RawMetadataItemName.SubjectDistance, out rawMdi))
            {
                if (rawMdi.ExtractedValueType == ExtractedValueType.Fraction)
                {
                    ...
                    return new MetaValue(String.Concat(distance.ToString("0.### ", CultureInfo.InvariantCulture), "meters"), distance.ToString("0.### ", CultureInfo.InvariantCulture));
                }
                else
                {
                    ...
                    {
                        return new MetaValue($"{value} meters", value);
                    }
                }
            }
            ...
            if (distanceWpf.HasValue)
            {
                ...
                return new MetaValue(String.Concat(distanceWpf.Value.ToString("0.### ", CultureInfo.InvariantCulture), "meters"), distanceWpf.Value.ToString("0.### ", CultureInfo.InvariantCulture));
            }
        ...
        private IMetaValue GetWidth()
        {
            ...
            return (width > 0 ? new MetaValue($"{width} px", width.ToString(CultureInfo.InvariantCulture)) : null);
        }
            ...
            switch (metaName)
            {
                ...
                case MetadataItemName.GpsAltitude:
                    if (GpsLocation.Altitude.HasValue)
                    {
                        ...
                        return new MetaValue($"{altitude} meters", altitude);
                    }
                    else
                        return null;
        ...
        //                bitmapMetadata.DateTaken = GetMetaValueForFile(metaItem);
        ...
        //                bitmapMetadata.Keywords = new System.Collections.ObjectModel.ReadOnlyCollection<string>(metaItem.Value.Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries));
