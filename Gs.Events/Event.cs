...
{
    /// <summary>
    /// Represents an application event or error that occurs during the execution of Gallery Server code.
    /// </summary>
    public class Event : IEvent, IComparable
    {
        ...
        private const string missingDataText = "<unknown>";
        private const string noDataText = "<none>";
        ...
        public string Url
        {
            get { return (!String.IsNullOrEmpty(_url) ? _url : missingDataText); }
        }
        ...
        public string HttpUserAgent
        {
            get
            {
                ...
                return httpUserAgent.Value ?? missingDataText;
            }
        }
        ...
        internal Event(Exception ex, int galleryId)
        {
            ...
            // DbEntityValidationException does not exist in EF Core, so this section does not apply.
        ...
        public string ToHtmlPage()
        {
            ...
            sb.AppendLine("<p>This error report was generated by Gallery Server.</p>");
        ...
        private static string ToHtmlParagraphs(ICollection<KeyValuePair<string, string>> list)
        {
            if ((list == null) || (list.Count == 0))
                return ToHtmlParagraph(noDataText);
...
<table cellpadding='0' cellspacing='0' class='gsp_event_table' style='width:100%;border:1px solid #cdc9c2;'>
 <tr><td style='padding:4px;'>{0}</td></tr>
</table>", ToHtmlParagraph(noDataText));
            }
        ...
        {
            sb.AppendLine(ToHtmlParagraph(String.Concat((EventType == EventType.Error ? "Message" : String.Empty), " ", Message), "gsp_event_h1", "margin:.5em 0 .5em 0;color:#800;font-size: 1.4em;"));
        ...
        {
            sb.AppendLine(ToHtmlParagraph("Event Summary", "gsp_event_h2", "background-color:#cdc9c2;font-size: 1.2em; font-weight: bold;margin:1em 0 0 0;padding:.4em 0 .4em 4px;"));
            sb.AppendLine("<table cellpadding='0' cellspacing='0' class='gsp_event_table' style='width:100%;border:1px solid #cdc9c2;'>");
